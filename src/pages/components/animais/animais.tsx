      ...
      <CustomerContainer>
        <div className="text">
          ...
          <p>
            ...
            cumque quos voluptate animi, suscipit voluptatem nisi officia,
            consectetur fuga voluptates alias minus natus veritatis, cum ab
            inventore nemo voluptas?
          </p>
        </div>
        <ButtonOpenModal customer="animais">
          <AnimalModal />
        </ButtonOpenModal>
        <TabelaAnimais />
      </CustomerContainer>
